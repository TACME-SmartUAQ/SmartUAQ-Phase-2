...
$.lblNavTitle.text = Alloy.Globals.selectedLanguage.forgotUsername;
var langVar = "en";
langVar =  (Alloy.Globals.isEnglish)? "en" : "ar";
$.webView.url = Alloy.Globals.webserviceUrl + "/PortalWorkspace/faces/forgotUserName?languagecode="+langVar;

Ti.API.info('Forgot Username web URL : '+$.webView.url);
