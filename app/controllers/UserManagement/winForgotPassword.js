...
$.lblNavTitle.text = Alloy.Globals.selectedLanguage.forgotPassword;
var langVar = "en";
langVar =  (Alloy.Globals.isEnglish)? "en" : "ar";
$.webView.url  = Alloy.Globals.webserviceUrl + "/PortalWorkspace/faces/forgotPassword?languagecode="+langVar;
